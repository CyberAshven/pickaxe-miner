...
import { NFTCapability } from "./types.js";
import { checkTokenaddr } from "./util.js";
...
export type SendRequestArray = Array<string | number | Uint8Array>;
